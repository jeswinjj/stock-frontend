...
export default function Dashboard() {
    ...
    if (loading) return <div className="flex items-center justify-center h-screen font-medium text-gray-500">Loading your portfolio...</div>;
    ...
    return (
        <div className="min-h-screen bg-[#F8FAFC] p-6 md:p-12">
            <div className="max-w-7xl mx-auto space-y-8">
                ...
                {toast && (
                    <div className={cn(
                        "fixed top-6 right-6 z-[100] p-4 rounded-2xl shadow-2xl flex items-center gap-3 border animate-in slide-in-from-right-8 duration-300",
                ...
                <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                    <div>
                        <h1 className="text-4xl font-extrabold text-gray-900 tracking-tight">Portfolio</h1>
                        <p className="text-gray-500 font-medium">Monitoring {stocks.length} assets</p>
                    </div>
                    <div className="flex flex-wrap gap-3">
                        <Button
                            variant="outline"
                            onClick={togglePrivacy}
                            className="h-12 w-12 p-0 rounded-xl border-gray-200 text-gray-400 hover:text-blue-600 hover:bg-blue-50 transition-all shadow-sm"
                        ...
                        <Button
                            ...
                            disabled={isFetching}
                            className="h-12 px-6 rounded-xl border-blue-200 text-blue-700 hover:bg-blue-50 font-bold transition-all shadow-sm"
                        >
                        ...
                        <Button
                            variant="outline"
                            onClick={logout}
                            className="h-12 w-12 p-0 rounded-xl border-gray-200 text-gray-400 hover:text-red-500 hover:bg-red-50 transition-all shadow-sm"
                        >
                            <LogOut size={20} />
                        </Button>
                    </div>
